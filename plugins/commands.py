...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 Dev ', url='https://t.me/JACK_DADDY')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ', url='https://t.me/JACK_DADDY'),
            InlineKeyboardButton('🤖 Owner', url='https://t.me/Samirmeshram')
            ],[
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ', url='https://t.me/JACK_DADDY'),
            InlineKeyboardButton('🤖 Own', url='https://t.me/Samirmeshram')
        ],[
            InlineKeyboardButton('💁‍♀️ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('😊 ᴀʙᴏᴜᴛ', callback_data='about')
        ]]
